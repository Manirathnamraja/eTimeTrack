CREATE VIEW vw_SRL_Employees AS
...
WHERE        (dbo.EmployeeProjects.ProjectId = 1747)
GO

  CREATE VIEW vw_SRL_EmployeeTimesheetItems AS
...
SELECT DISTINCT ET.[TimesheetID]
  ...
  CREATE VIEW vw_SRL_ProjectGroups AS 
  SELECT [GroupID]
      ,[ProjectID]
      ,[PartID]
      ,[GroupNo]
	...
	WHERE (ProjectID = 1747)
	GO
  
  CREATE VIEW vw_SRL_ProjectParts AS 
  SELECT [PartID]
      ,[ProjectID]
      ,[PartNo]
      ,[Name]
  ...
  CREATE VIEW vw_SRL_Projects AS 
  SELECT [ProjectID]
      ,[ProjectNo]
      ,[OfficeID]
      ,[SeqNo]
  ...
  CREATE VIEW vw_SRL_ProjectTasks AS 
  SELECT [TaskID]
      ,[ProjectID]
      ,[GroupID]
      ,[TaskNo]
  ...
  CREATE VIEW vw_SRL_ProjectVariationItems AS 
  ...
  CREATE VIEW vw_SRL_ProjectVariations AS 
  SELECT [VariationID]
      ,[ProjectID]
      ,[VariationNo]
      ,[RevNo]
	...
	CREATE VIEW vw_SRL_ProjectTimeCodeConfigs AS 
	SELECT
	...
	CREATE VIEW vw_SRL_Custom_Report AS 
	SELECT
	...
	WHERE ProjectUserTypes.ProjectID = 1747
	GO
	
	CREATE VIEW vw_SRL_ProjectEmployeeDetails AS 
	SELECT 
	...
	WHERE 
	EmployeeProjects.ProjectID = 1747
	...
	AND ProjectUserTypes.ProjectID = 1747
	GO
	
	CREATE VIEW vw_SRL_ProjectUserTimesheetItems AS 
	SELECT 
	...
	LEFT JOIN ProjectUserTypes ON EmployeeProjects.ProjectUserTypeID = ProjectUserTypes.ProjectUserTypeID
	WHERE 
	ProjectTasks.ProjectID = 1747 
	AND EmployeeProjects.ProjectID = 1747
	AND EmployeeProjects.ProjectUserTypeID IS NOT NULL
