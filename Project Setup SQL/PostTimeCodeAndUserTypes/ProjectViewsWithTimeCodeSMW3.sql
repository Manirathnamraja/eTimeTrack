CREATE VIEW vw_SMW3_Employees AS
...
WHERE        (dbo.EmployeeProjects.ProjectId = 1671)
GO

  CREATE VIEW vw_SMW3_EmployeeTimesheetItems AS
...
SELECT DISTINCT ET.[TimesheetID]
  ...
  CREATE VIEW vw_SMW3_ProjectGroups AS 
  SELECT [GroupID]
      ,[ProjectID]
      ,[PartID]
      ,[GroupNo]
	...
	WHERE (ProjectID = 1671)
	GO
  
  CREATE VIEW vw_SMW3_ProjectParts AS 
  SELECT [PartID]
      ,[ProjectID]
      ,[PartNo]
      ,[Name]
  ...
  CREATE VIEW vw_SMW3_Projects AS 
  SELECT [ProjectID]
      ,[ProjectNo]
      ,[OfficeID]
      ,[SeqNo]
  ...
  CREATE VIEW vw_SMW3_ProjectTasks AS 
  SELECT [TaskID]
      ,[ProjectID]
      ,[GroupID]
      ,[TaskNo]
  ...
  CREATE VIEW vw_SMW3_ProjectVariationItems AS 
  ...
  CREATE VIEW vw_SMW3_ProjectVariations AS 
  SELECT [VariationID]
      ,[ProjectID]
      ,[VariationNo]
      ,[RevNo]
	...
	CREATE VIEW vw_SMW3_ProjectTimeCodeConfigs AS 
	SELECT
	...
	CREATE VIEW vw_SMW3_Custom_Report AS 
	SELECT
	...
	WHERE ProjectUserTypes.ProjectID = 1671
	GO
	
	CREATE VIEW vw_SMW3_ProjectEmployeeDetails AS 
	SELECT 
	...
	WHERE 
	EmployeeProjects.ProjectID = 1671
	...
	AND ProjectUserTypes.ProjectID = 1671
	GO
	
	CREATE VIEW vw_SMW3_ProjectUserTimesheetItems AS 
	SELECT 
	...
	LEFT JOIN ProjectUserTypes ON EmployeeProjects.ProjectUserTypeID = ProjectUserTypes.ProjectUserTypeID
	WHERE 
	ProjectTasks.ProjectID = 1671 
	AND EmployeeProjects.ProjectID = 1671
	AND EmployeeProjects.ProjectUserTypeID IS NOT NULL
