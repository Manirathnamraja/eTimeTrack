CREATE VIEW vw_CRU_Employees AS
...
WHERE        (dbo.EmployeeProjects.ProjectId = 1653)
GO

  CREATE VIEW vw_CRU_EmployeeTimesheetItems AS
...
SELECT DISTINCT ET.[TimesheetID]
  ...
  CREATE VIEW vw_CRU_ProjectGroups AS 
  SELECT [GroupID]
      ,[ProjectID]
      ,[PartID]
      ,[GroupNo]
	...
	WHERE (ProjectID = 1653)
	GO
  
  CREATE VIEW vw_CRU_ProjectParts AS 
  SELECT [PartID]
      ,[ProjectID]
      ,[PartNo]
      ,[Name]
  ...
  CREATE VIEW vw_CRU_Projects AS 
  SELECT [ProjectID]
      ,[ProjectNo]
      ,[OfficeID]
      ,[SeqNo]
  ...
  CREATE VIEW vw_CRU_ProjectTasks AS 
  SELECT [TaskID]
      ,[ProjectID]
      ,[GroupID]
      ,[TaskNo]
  ...
  CREATE VIEW vw_CRU_ProjectVariationItems AS 
  ...
  CREATE VIEW vw_CRU_ProjectVariations AS 
  SELECT [VariationID]
      ,[ProjectID]
      ,[VariationNo]
      ,[RevNo]
	...
	CREATE VIEW vw_CRU_ProjectTimeCodeConfigs AS 
	SELECT
	...
	CREATE VIEW vw_CRU_Custom_Report AS 
	SELECT
	...
	WHERE dbo.Projects.ProjectID = 1653
