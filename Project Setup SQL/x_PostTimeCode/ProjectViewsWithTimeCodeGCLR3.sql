CREATE VIEW vw_GCLR3_Employees AS
...
WHERE        (dbo.EmployeeProjects.ProjectId = 1646)
GO

  CREATE VIEW vw_GCLR3_EmployeeTimesheetItems AS
...
SELECT DISTINCT ET.[TimesheetID]
  ...
  CREATE VIEW vw_GCLR3_ProjectGroups AS 
  SELECT [GroupID]
      ,[ProjectID]
      ,[PartID]
      ,[GroupNo]
	...
	WHERE (ProjectID = 1646)
	GO
  
  CREATE VIEW vw_GCLR3_ProjectParts AS 
  SELECT [PartID]
      ,[ProjectID]
      ,[PartNo]
      ,[Name]
  ...
  CREATE VIEW vw_GCLR3_Projects AS 
  SELECT [ProjectID]
      ,[ProjectNo]
      ,[OfficeID]
      ,[SeqNo]
  ...
  CREATE VIEW vw_GCLR3_ProjectTasks AS 
  SELECT [TaskID]
      ,[ProjectID]
      ,[GroupID]
      ,[TaskNo]
  ...
  CREATE VIEW vw_GCLR3_ProjectVariationItems AS 
  ...
  CREATE VIEW vw_GCLR3_ProjectVariations AS 
  SELECT [VariationID]
      ,[ProjectID]
      ,[VariationNo]
      ,[RevNo]
	...
	CREATE VIEW vw_GCLR3_ProjectTimeCodeConfigs AS 
	SELECT
	...
	CREATE VIEW vw_GCLR3_Custom_Report AS 
	SELECT
	...
	WHERE dbo.Projects.ProjectID = 1646
