CREATE VIEW vw_CLR2A_Employees AS
...
WHERE        (dbo.EmployeeProjects.ProjectId = 1540)
GO

  CREATE VIEW vw_CLR2A_EmployeeTimesheetItems AS
...
SELECT DISTINCT ET.[TimesheetID]
  ...
  CREATE VIEW vw_CLR2A_ProjectGroups AS 
  SELECT [GroupID]
      ,[ProjectID]
      ,[PartID]
      ,[GroupNo]
	...
	WHERE (ProjectID = 1540)
	GO
  
  CREATE VIEW vw_CLR2A_ProjectParts AS 
  SELECT [PartID]
      ,[ProjectID]
      ,[PartNo]
      ,[Name]
  ...
  CREATE VIEW vw_CLR2A_Projects AS 
  SELECT [ProjectID]
      ,[ProjectNo]
      ,[OfficeID]
      ,[SeqNo]
  ...
  CREATE VIEW vw_CLR2A_ProjectTasks AS 
  SELECT [TaskID]
      ,[ProjectID]
      ,[GroupID]
      ,[TaskNo]
  ...
  CREATE VIEW vw_CLR2A_ProjectVariationItems AS 
  ...
  CREATE VIEW vw_CLR2A_ProjectVariations AS 
  SELECT [VariationID]
      ,[ProjectID]
      ,[VariationNo]
      ,[RevNo]
	...
	CREATE VIEW vw_CLR2A_ProjectTimeCodeConfigs AS 
	SELECT
	...
	CREATE VIEW vw_CLR2A_Custom_Report AS 
	SELECT
	...
	WHERE dbo.Projects.ProjectID = 1540
