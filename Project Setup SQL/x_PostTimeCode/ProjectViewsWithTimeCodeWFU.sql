CREATE VIEW vw_WFU_Employees AS
...
WHERE        (dbo.EmployeeProjects.ProjectId = 1644)
GO

  CREATE VIEW vw_WFU_EmployeeTimesheetItems AS
...
SELECT DISTINCT ET.[TimesheetID]
  ...
  CREATE VIEW vw_WFU_ProjectGroups AS 
  SELECT [GroupID]
      ,[ProjectID]
      ,[PartID]
      ,[GroupNo]
	...
	WHERE (ProjectID = 1644)
	GO
  
  CREATE VIEW vw_WFU_ProjectParts AS 
  SELECT [PartID]
      ,[ProjectID]
      ,[PartNo]
      ,[Name]
  ...
  CREATE VIEW vw_WFU_Projects AS 
  SELECT [ProjectID]
      ,[ProjectNo]
      ,[OfficeID]
      ,[SeqNo]
  ...
  CREATE VIEW vw_WFU_ProjectTasks AS 
  SELECT [TaskID]
      ,[ProjectID]
      ,[GroupID]
      ,[TaskNo]
  ...
  CREATE VIEW vw_WFU_ProjectVariationItems AS 
  ...
  CREATE VIEW vw_WFU_ProjectVariations AS 
  SELECT [VariationID]
      ,[ProjectID]
      ,[VariationNo]
      ,[RevNo]
	...
	CREATE VIEW vw_WFU_ProjectTimeCodeConfigs AS 
	SELECT
	...
	CREATE VIEW vw_WFU_Custom_Report AS 
	SELECT
	...
	WHERE dbo.Projects.ProjectID = 1644
