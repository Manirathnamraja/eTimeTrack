CREATE VIEW vw_NEL_Employees AS
...
WHERE        (dbo.EmployeeProjects.ProjectId = 1510)
GO

  CREATE VIEW vw_NEL_EmployeeTimesheetItems AS
...
SELECT DISTINCT ET.[TimesheetID]
  ...
  CREATE VIEW vw_NEL_ProjectGroups AS 
  SELECT [GroupID]
      ,[ProjectID]
      ,[PartID]
      ,[GroupNo]
	...
	WHERE (ProjectID = 1510)
	GO
  
  CREATE VIEW vw_NEL_ProjectParts AS 
  SELECT [PartID]
      ,[ProjectID]
      ,[PartNo]
      ,[Name]
  ...
  CREATE VIEW vw_NEL_Projects AS 
  SELECT [ProjectID]
      ,[ProjectNo]
      ,[OfficeID]
      ,[SeqNo]
  ...
  CREATE VIEW vw_NEL_ProjectTasks AS 
  SELECT [TaskID]
      ,[ProjectID]
      ,[GroupID]
      ,[TaskNo]
  ...
  CREATE VIEW vw_NEL_ProjectVariationItems AS 
  ...
  CREATE VIEW vw_NEL_ProjectVariations AS 
  SELECT [VariationID]
      ,[ProjectID]
      ,[VariationNo]
      ,[RevNo]
	...
	CREATE VIEW vw_NEL_ProjectTimeCodeConfigs AS 
	SELECT
	...
	CREATE VIEW vw_NEL_Custom_Report AS 
	SELECT
	...
	WHERE dbo.Projects.ProjectID = 1510
	GO
