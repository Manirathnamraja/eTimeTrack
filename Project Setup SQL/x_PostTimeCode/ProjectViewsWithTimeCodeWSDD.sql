CREATE VIEW vw_WSDD_Employees AS
...
WHERE        (dbo.EmployeeProjects.ProjectId = 1544)
GO

  CREATE VIEW vw_WSDD_EmployeeTimesheetItems AS
...
SELECT DISTINCT ET.[TimesheetID]
  ...
  CREATE VIEW vw_WSDD_ProjectGroups AS 
  SELECT [GroupID]
      ,[ProjectID]
      ,[PartID]
      ,[GroupNo]
	...
	WHERE (ProjectID = 1544)
	GO
  
  CREATE VIEW vw_WSDD_ProjectParts AS 
  SELECT [PartID]
      ,[ProjectID]
      ,[PartNo]
      ,[Name]
  ...
  CREATE VIEW vw_WSDD_Projects AS 
  SELECT [ProjectID]
      ,[ProjectNo]
      ,[OfficeID]
      ,[SeqNo]
  ...
  CREATE VIEW vw_WSDD_ProjectTasks AS 
  SELECT [TaskID]
      ,[ProjectID]
      ,[GroupID]
      ,[TaskNo]
  ...
  CREATE VIEW vw_WSDD_ProjectVariationItems AS 
  ...
  CREATE VIEW vw_WSDD_ProjectVariations AS 
  SELECT [VariationID]
      ,[ProjectID]
      ,[VariationNo]
      ,[RevNo]
	...
	CREATE VIEW vw_WSDD_ProjectTimeCodeConfigs AS 
	SELECT
	...
	CREATE VIEW vw_WSDD_Custom_Report AS 
	SELECT
	...
	WHERE dbo.Projects.ProjectID = 1544
