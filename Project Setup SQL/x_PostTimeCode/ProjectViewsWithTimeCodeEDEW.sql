CREATE VIEW vw_EDEW_Employees AS
...
WHERE        (dbo.EmployeeProjects.ProjectId = 1629)
GO

  CREATE VIEW vw_EDEW_EmployeeTimesheetItems AS
...
SELECT DISTINCT ET.[TimesheetID]
  ...
  CREATE VIEW vw_EDEW_ProjectGroups AS 
  SELECT [GroupID]
      ,[ProjectID]
      ,[PartID]
      ,[GroupNo]
	...
	WHERE (ProjectID = 1629)
	GO
  
  CREATE VIEW vw_EDEW_ProjectParts AS 
  SELECT [PartID]
      ,[ProjectID]
      ,[PartNo]
      ,[Name]
  ...
  CREATE VIEW vw_EDEW_Projects AS 
  SELECT [ProjectID]
      ,[ProjectNo]
      ,[OfficeID]
      ,[SeqNo]
  ...
  CREATE VIEW vw_EDEW_ProjectTasks AS 
  SELECT [TaskID]
      ,[ProjectID]
      ,[GroupID]
      ,[TaskNo]
  ...
  CREATE VIEW vw_EDEW_ProjectVariationItems AS 
  ...
  CREATE VIEW vw_EDEW_ProjectVariations AS 
  SELECT [VariationID]
      ,[ProjectID]
      ,[VariationNo]
      ,[RevNo]
	...
	CREATE VIEW vw_EDEW_ProjectTimeCodeConfigs AS 
	SELECT
	...
	CREATE VIEW vw_EDEW_Custom_Report AS 
	SELECT
	...
	WHERE dbo.Projects.ProjectID = 1629
