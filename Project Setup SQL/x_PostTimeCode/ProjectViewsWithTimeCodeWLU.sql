CREATE VIEW vw_WLU_Employees AS
...
WHERE        (dbo.EmployeeProjects.ProjectId = 1545)
GO

  CREATE VIEW vw_WLU_EmployeeTimesheetItems AS
...
SELECT DISTINCT ET.[TimesheetID]
  ...
  CREATE VIEW vw_WLU_ProjectGroups AS 
  SELECT [GroupID]
      ,[ProjectID]
      ,[PartID]
      ,[GroupNo]
	...
	WHERE (ProjectID = 1545)
	GO
  
  CREATE VIEW vw_WLU_ProjectParts AS 
  SELECT [PartID]
      ,[ProjectID]
      ,[PartNo]
      ,[Name]
  ...
  CREATE VIEW vw_WLU_Projects AS 
  SELECT [ProjectID]
      ,[ProjectNo]
      ,[OfficeID]
      ,[SeqNo]
  ...
  CREATE VIEW vw_WLU_ProjectTasks AS 
  SELECT [TaskID]
      ,[ProjectID]
      ,[GroupID]
      ,[TaskNo]
  ...
  CREATE VIEW vw_WLU_ProjectVariationItems AS 
  ...
  CREATE VIEW vw_WLU_ProjectVariations AS 
  SELECT [VariationID]
      ,[ProjectID]
      ,[VariationNo]
      ,[RevNo]
	...
	CREATE VIEW vw_WLU_ProjectTimeCodeConfigs AS 
	SELECT
	...
	CREATE VIEW vw_WLU_Custom_Report AS 
	SELECT
	...
	WHERE dbo.Projects.ProjectID = 1545
