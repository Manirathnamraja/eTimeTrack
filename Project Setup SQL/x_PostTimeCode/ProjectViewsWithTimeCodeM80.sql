CREATE VIEW vw_M80_Employees AS
...
WHERE        (dbo.EmployeeProjects.ProjectId = 1534)
GO

  CREATE VIEW vw_M80_EmployeeTimesheetItems AS
...
SELECT DISTINCT ET.[TimesheetID]
  ...
  CREATE VIEW vw_M80_ProjectGroups AS 
  SELECT [GroupID]
      ,[ProjectID]
      ,[PartID]
      ,[GroupNo]
	...
	WHERE (ProjectID = 1534)
	GO
  
  CREATE VIEW vw_M80_ProjectParts AS 
  SELECT [PartID]
      ,[ProjectID]
      ,[PartNo]
      ,[Name]
  ...
  CREATE VIEW vw_M80_Projects AS 
  SELECT [ProjectID]
      ,[ProjectNo]
      ,[OfficeID]
      ,[SeqNo]
  ...
  CREATE VIEW vw_M80_ProjectTasks AS 
  SELECT [TaskID]
      ,[ProjectID]
      ,[GroupID]
      ,[TaskNo]
  ...
  CREATE VIEW vw_M80_ProjectVariationItems AS 
  ...
  CREATE VIEW vw_M80_ProjectVariations AS 
  SELECT [VariationID]
      ,[ProjectID]
      ,[VariationNo]
      ,[RevNo]
	...
	CREATE VIEW vw_M80_ProjectTimeCodeConfigs AS 
	SELECT
	...
	CREATE VIEW vw_M80_Custom_Report AS 
	SELECT
	...
	WHERE dbo.Projects.ProjectID = 1534
