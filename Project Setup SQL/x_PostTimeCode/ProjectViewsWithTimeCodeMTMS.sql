CREATE VIEW vw_MTMS_Employees AS
...
WHERE        (dbo.EmployeeProjects.ProjectId = 1525)
GO

  CREATE VIEW vw_MTMS_EmployeeTimesheetItems AS
...
SELECT DISTINCT ET.[TimesheetID]
  ...
  CREATE VIEW vw_MTMS_ProjectGroups AS 
  SELECT [GroupID]
      ,[ProjectID]
      ,[PartID]
      ,[GroupNo]
	...
	WHERE (ProjectID = 1525)
	GO
  
  CREATE VIEW vw_MTMS_ProjectParts AS 
  SELECT [PartID]
      ,[ProjectID]
      ,[PartNo]
      ,[Name]
  ...
  CREATE VIEW vw_MTMS_Projects AS 
  SELECT [ProjectID]
      ,[ProjectNo]
      ,[OfficeID]
      ,[SeqNo]
  ...
  CREATE VIEW vw_MTMS_ProjectTasks AS 
  SELECT [TaskID]
      ,[ProjectID]
      ,[GroupID]
      ,[TaskNo]
  ...
  CREATE VIEW vw_MTMS_ProjectVariationItems AS 
  ...
  CREATE VIEW vw_MTMS_ProjectVariations AS 
  SELECT [VariationID]
      ,[ProjectID]
      ,[VariationNo]
      ,[RevNo]
	...
	CREATE VIEW vw_MTMS_ProjectTimeCodeConfigs AS 
	SELECT
	...
	CREATE VIEW vw_MTMS_Custom_Report AS 
	SELECT
	...
	WHERE dbo.Projects.ProjectID = 1525
