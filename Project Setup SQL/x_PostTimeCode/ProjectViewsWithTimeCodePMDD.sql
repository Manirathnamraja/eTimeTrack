CREATE VIEW vw_PMDD_Employees AS
...
WHERE        (dbo.EmployeeProjects.ProjectId = 1543)
GO

  CREATE VIEW vw_PMDD_EmployeeTimesheetItems AS
...
SELECT DISTINCT ET.[TimesheetID]
  ...
  CREATE VIEW vw_PMDD_ProjectGroups AS 
  SELECT [GroupID]
      ,[ProjectID]
      ,[PartID]
      ,[GroupNo]
	...
	WHERE (ProjectID = 1543)
	GO
  
  CREATE VIEW vw_PMDD_ProjectParts AS 
  SELECT [PartID]
      ,[ProjectID]
      ,[PartNo]
      ,[Name]
  ...
  CREATE VIEW vw_PMDD_Projects AS 
  SELECT [ProjectID]
      ,[ProjectNo]
      ,[OfficeID]
      ,[SeqNo]
  ...
  CREATE VIEW vw_PMDD_ProjectTasks AS 
  SELECT [TaskID]
      ,[ProjectID]
      ,[GroupID]
      ,[TaskNo]
  ...
  CREATE VIEW vw_PMDD_ProjectVariationItems AS 
  ...
  CREATE VIEW vw_PMDD_ProjectVariations AS 
  SELECT [VariationID]
      ,[ProjectID]
      ,[VariationNo]
      ,[RevNo]
	...
	CREATE VIEW vw_PMDD_ProjectTimeCodeConfigs AS 
	SELECT
	...
	CREATE VIEW vw_PMDD_Custom_Report AS 
	SELECT
	...
	WHERE dbo.Projects.ProjectID = 1543
