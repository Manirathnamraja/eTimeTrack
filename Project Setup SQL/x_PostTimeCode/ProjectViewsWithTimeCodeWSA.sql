CREATE VIEW vw_WSA_Employees AS
...
WHERE        (dbo.EmployeeProjects.ProjectId = 1654)
GO

  CREATE VIEW vw_WSA_EmployeeTimesheetItems AS
...
SELECT DISTINCT ET.[TimesheetID]
  ...
  CREATE VIEW vw_WSA_ProjectGroups AS 
  SELECT [GroupID]
      ,[ProjectID]
      ,[PartID]
      ,[GroupNo]
	...
	WHERE (ProjectID = 1654)
	GO
  
  CREATE VIEW vw_WSA_ProjectParts AS 
  SELECT [PartID]
      ,[ProjectID]
      ,[PartNo]
      ,[Name]
  ...
  CREATE VIEW vw_WSA_Projects AS 
  SELECT [ProjectID]
      ,[ProjectNo]
      ,[OfficeID]
      ,[SeqNo]
  ...
  CREATE VIEW vw_WSA_ProjectTasks AS 
  SELECT [TaskID]
      ,[ProjectID]
      ,[GroupID]
      ,[TaskNo]
  ...
  CREATE VIEW vw_WSA_ProjectVariationItems AS 
  ...
  CREATE VIEW vw_WSA_ProjectVariations AS 
  SELECT [VariationID]
      ,[ProjectID]
      ,[VariationNo]
      ,[RevNo]
	...
	CREATE VIEW vw_WSA_ProjectTimeCodeConfigs AS 
	SELECT
	...
	CREATE VIEW vw_WSA_Custom_Report AS 
	SELECT
	...
	WHERE dbo.Projects.ProjectID = 1654
