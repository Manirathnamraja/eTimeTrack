CREATE VIEW vw_BORR_Employees AS
...
WHERE        (dbo.EmployeeProjects.ProjectId = 1567)
GO

  CREATE VIEW vw_BORR_EmployeeTimesheetItems AS
...
SELECT DISTINCT ET.[TimesheetID]
  ...
  CREATE VIEW vw_BORR_ProjectGroups AS 
  SELECT [GroupID]
      ,[ProjectID]
      ,[PartID]
      ,[GroupNo]
	...
	WHERE (ProjectID = 1567)
	GO
  
  CREATE VIEW vw_BORR_ProjectParts AS 
  SELECT [PartID]
      ,[ProjectID]
      ,[PartNo]
      ,[Name]
  ...
  CREATE VIEW vw_BORR_Projects AS 
  SELECT [ProjectID]
      ,[ProjectNo]
      ,[OfficeID]
      ,[SeqNo]
  ...
  CREATE VIEW vw_BORR_ProjectTasks AS 
  SELECT [TaskID]
      ,[ProjectID]
      ,[GroupID]
      ,[TaskNo]
  ...
  CREATE VIEW vw_BORR_ProjectVariationItems AS 
  ...
  CREATE VIEW vw_BORR_ProjectVariations AS 
  SELECT [VariationID]
      ,[ProjectID]
      ,[VariationNo]
      ,[RevNo]
	...
	CREATE VIEW vw_BORR_ProjectTimeCodeConfigs AS 
	SELECT
	...
	CREATE VIEW vw_BORR_Custom_Report AS 
	SELECT
	...
	WHERE dbo.Projects.ProjectID = 1567
