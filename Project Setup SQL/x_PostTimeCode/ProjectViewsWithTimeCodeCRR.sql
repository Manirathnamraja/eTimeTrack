CREATE VIEW vw_CRR_Employees AS
...
WHERE        (dbo.EmployeeProjects.ProjectId = 1504)
GO

  CREATE VIEW vw_CRR_EmployeeTimesheetItems AS
  ...
  WHERE PV.ProjectID = 1504
GO
  
  CREATE VIEW vw_CRR_EmployeeTimesheets AS
SELECT DISTINCT ET.[TimesheetID]
  ...
  CREATE VIEW vw_CRR_ProjectGroups AS 
  SELECT [GroupID]
      ,[ProjectID]
      ,[PartID]
      ,[GroupNo]
	...
	WHERE (ProjectID = 1504)
	GO
  
  CREATE VIEW vw_CRR_ProjectParts AS 
  SELECT [PartID]
      ,[ProjectID]
      ,[PartNo]
      ,[Name]
  ...
  CREATE VIEW vw_CRR_Projects AS 
  SELECT [ProjectID]
      ,[ProjectNo]
      ,[OfficeID]
      ,[SeqNo]
  ...
  CREATE VIEW vw_CRR_ProjectTasks AS 
  SELECT [TaskID]
      ,[ProjectID]
      ,[GroupID]
      ,[TaskNo]
  ...
  CREATE VIEW vw_CRR_ProjectVariationItems AS 
  ...
  CREATE VIEW vw_CRR_ProjectVariations AS 
  SELECT [VariationID]
      ,[ProjectID]
      ,[VariationNo]
      ,[RevNo]
