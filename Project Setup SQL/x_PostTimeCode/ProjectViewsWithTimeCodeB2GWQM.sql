CREATE VIEW vw_B2GWQM_Employees AS
...
WHERE        (dbo.EmployeeProjects.ProjectId = 1659)
GO

  CREATE VIEW vw_B2GWQM_EmployeeTimesheetItems AS
...
SELECT DISTINCT ET.[TimesheetID]
  ...
  CREATE VIEW vw_B2GWQM_ProjectGroups AS 
  SELECT [GroupID]
      ,[ProjectID]
      ,[PartID]
      ,[GroupNo]
	...
	WHERE (ProjectID = 1659)
	GO
  
  CREATE VIEW vw_B2GWQM_ProjectParts AS 
  SELECT [PartID]
      ,[ProjectID]
      ,[PartNo]
      ,[Name]
  ...
  CREATE VIEW vw_B2GWQM_Projects AS 
  SELECT [ProjectID]
      ,[ProjectNo]
      ,[OfficeID]
      ,[SeqNo]
  ...
  CREATE VIEW vw_B2GWQM_ProjectTasks AS 
  SELECT [TaskID]
      ,[ProjectID]
      ,[GroupID]
      ,[TaskNo]
  ...
  CREATE VIEW vw_B2GWQM_ProjectVariationItems AS 
  ...
  CREATE VIEW vw_B2GWQM_ProjectVariations AS 
  SELECT [VariationID]
      ,[ProjectID]
      ,[VariationNo]
      ,[RevNo]
	...
	CREATE VIEW vw_B2GWQM_ProjectTimeCodeConfigs AS 
	SELECT
	...
	CREATE VIEW vw_B2GWQM_Custom_Report AS 
	SELECT
	...
	WHERE dbo.Projects.ProjectID = 1659
