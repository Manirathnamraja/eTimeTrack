CREATE VIEW vw_M4M5MOD1_Employees AS
...
WHERE        (dbo.EmployeeProjects.ProjectId = 1472)
GO

  CREATE VIEW vw_M4M5MOD1_EmployeeTimesheetItems AS
  ...
  WHERE PV.ProjectID = 1472
GO
  
  CREATE VIEW vw_M4M5MOD1_EmployeeTimesheets AS
SELECT DISTINCT ET.[TimesheetID]
  ...
  CREATE VIEW vw_M4M5MOD1_ProjectGroups AS 
  SELECT [GroupID]
      ,[ProjectID]
      ,[PartID]
      ,[GroupNo]
	...
	WHERE (ProjectID = 1472)
	GO
  
  CREATE VIEW vw_M4M5MOD1_ProjectParts AS 
  SELECT [PartID]
      ,[ProjectID]
      ,[PartNo]
      ,[Name]
  ...
  CREATE VIEW vw_M4M5MOD1_Projects AS 
  SELECT [ProjectID]
      ,[ProjectNo]
      ,[OfficeID]
      ,[SeqNo]
  ...
  CREATE VIEW vw_M4M5MOD1_ProjectTasks AS 
  SELECT [TaskID]
      ,[ProjectID]
      ,[GroupID]
      ,[TaskNo]
  ...
  CREATE VIEW vw_M4M5MOD1_ProjectVariationItems AS 
  ...
  CREATE VIEW vw_M4M5MOD1_ProjectVariations AS 
  SELECT [VariationID]
      ,[ProjectID]
      ,[VariationNo]
      ,[RevNo]
