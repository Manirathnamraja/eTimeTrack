CREATE VIEW vw_SWMSA_Employees AS
...
WHERE        (dbo.EmployeeProjects.ProjectId = 1484)
GO

  CREATE VIEW vw_SWMSA_EmployeeTimesheetItems AS
  ...
  WHERE PV.ProjectID = 1484
GO
  
  CREATE VIEW vw_SWMSA_EmployeeTimesheets AS
SELECT DISTINCT ET.[TimesheetID]
  ...
  CREATE VIEW vw_SWMSA_ProjectGroups AS 
  SELECT [GroupID]
      ,[ProjectID]
      ,[PartID]
      ,[GroupNo]
	...
	WHERE (ProjectID = 1484)
	GO
  
  CREATE VIEW vw_SWMSA_ProjectParts AS 
  SELECT [PartID]
      ,[ProjectID]
      ,[PartNo]
      ,[Name]
  ...
  CREATE VIEW vw_SWMSA_Projects AS 
  SELECT [ProjectID]
      ,[ProjectNo]
      ,[OfficeID]
      ,[SeqNo]
  ...
  CREATE VIEW vw_SWMSA_ProjectTasks AS 
  SELECT [TaskID]
      ,[ProjectID]
      ,[GroupID]
      ,[TaskNo]
  ...
  CREATE VIEW vw_SWMSA_ProjectVariationItems AS 
  ...
  CREATE VIEW vw_SWMSA_ProjectVariations AS 
  SELECT [VariationID]
      ,[ProjectID]
      ,[VariationNo]
      ,[RevNo]
