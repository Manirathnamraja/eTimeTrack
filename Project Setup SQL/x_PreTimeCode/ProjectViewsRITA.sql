CREATE VIEW vw_RITA_Employees AS
...
WHERE        (dbo.EmployeeProjects.ProjectId = 1406)
GO

  CREATE VIEW vw_RITA_EmployeeTimesheetItems AS
  ...
  WHERE PV.ProjectID = 1406
GO
  
  CREATE VIEW vw_RITA_EmployeeTimesheets AS
SELECT DISTINCT ET.[TimesheetID]
  ...
  CREATE VIEW vw_RITA_ProjectGroups AS 
  SELECT [GroupID]
      ,[ProjectID]
      ,[PartID]
      ,[GroupNo]
	...
	WHERE (ProjectID = 1406)
	GO
  
  CREATE VIEW vw_RITA_ProjectParts AS 
  SELECT [PartID]
      ,[ProjectID]
      ,[PartNo]
      ,[Name]
  ...
  CREATE VIEW vw_RITA_Projects AS 
  SELECT [ProjectID]
      ,[ProjectNo]
      ,[OfficeID]
      ,[SeqNo]
  ...
  CREATE VIEW vw_RITA_ProjectTasks AS 
  SELECT [TaskID]
      ,[ProjectID]
      ,[GroupID]
      ,[TaskNo]
  ...
  CREATE VIEW vw_RITA_ProjectVariationItems AS 
  ...
  CREATE VIEW vw_RITA_ProjectVariations AS 
  SELECT [VariationID]
      ,[ProjectID]
      ,[VariationNo]
      ,[RevNo]
