CREATE VIEW vw_CRLC3_Employees AS
...
WHERE        (dbo.EmployeeProjects.ProjectId = 1475)
GO

  CREATE VIEW vw_CRLC3_EmployeeTimesheetItems AS
  ...
  WHERE PV.ProjectID = 1475
GO
  
  CREATE VIEW vw_CRLC3_EmployeeTimesheets AS
SELECT DISTINCT ET.[TimesheetID]
  ...
  CREATE VIEW vw_CRLC3_ProjectGroups AS 
  SELECT [GroupID]
      ,[ProjectID]
      ,[PartID]
      ,[GroupNo]
	...
	WHERE (ProjectID = 1475)
	GO
  
  CREATE VIEW vw_CRLC3_ProjectParts AS 
  SELECT [PartID]
      ,[ProjectID]
      ,[PartNo]
      ,[Name]
  ...
  CREATE VIEW vw_CRLC3_Projects AS 
  SELECT [ProjectID]
      ,[ProjectNo]
      ,[OfficeID]
      ,[SeqNo]
  ...
  CREATE VIEW vw_CRLC3_ProjectTasks AS 
  SELECT [TaskID]
      ,[ProjectID]
      ,[GroupID]
      ,[TaskNo]
  ...
  CREATE VIEW vw_CRLC3_ProjectVariationItems AS 
  ...
  CREATE VIEW vw_CRLC3_ProjectVariations AS 
  SELECT [VariationID]
      ,[ProjectID]
      ,[VariationNo]
      ,[RevNo]
