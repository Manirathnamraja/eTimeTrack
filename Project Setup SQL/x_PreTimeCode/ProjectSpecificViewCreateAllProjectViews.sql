CREATE VIEW vw_ABC_Employees AS
...
WHERE        (dbo.EmployeeProjects.ProjectId = 1234)
GO

  CREATE VIEW vw_ABC_EmployeeTimesheetItems AS
  ...
  WHERE PV.ProjectID = 1234
GO
  
  CREATE VIEW vw_ABC_EmployeeTimesheets AS
SELECT DISTINCT ET.[TimesheetID]
  ...
  CREATE VIEW vw_ABC_ProjectGroups AS 
  SELECT [GroupID]
      ,[ProjectID]
      ,[PartID]
      ,[GroupNo]
  ...
  CREATE VIEW vw_ABC_ProjectParts AS 
  SELECT [PartID]
      ,[ProjectID]
      ,[PartNo]
      ,[Name]
  ...
  CREATE VIEW vw_ABC_Projects AS 
  SELECT [ProjectID]
      ,[ProjectNo]
      ,[OfficeID]
      ,[SeqNo]
  ...
  CREATE VIEW vw_ABC_ProjectTasks AS 
  SELECT [TaskID]
      ,[ProjectID]
      ,[GroupID]
      ,[TaskNo]
  ...
  CREATE VIEW vw_ABC_ProjectVariationItems AS 
  ...
  CREATE VIEW vw_ABC_ProjectVariations AS 
  SELECT [VariationID]
      ,[ProjectID]
      ,[VariationNo]
      ,[RevNo]
