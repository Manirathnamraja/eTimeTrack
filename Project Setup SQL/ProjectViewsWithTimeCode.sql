CREATE VIEW vw_XXX_Employees AS
...
WHERE        (dbo.EmployeeProjects.ProjectId = 1111)
GO

  CREATE VIEW vw_XXX_EmployeeTimesheetItems AS
...
SELECT DISTINCT ET.[TimesheetID]
  ...
  CREATE VIEW vw_XXX_ProjectGroups AS 
  SELECT [GroupID]
      ,[ProjectID]
      ,[PartID]
      ,[GroupNo]
	...
	WHERE (ProjectID = 1111)
	GO
  
  CREATE VIEW vw_XXX_ProjectParts AS 
  SELECT [PartID]
      ,[ProjectID]
      ,[PartNo]
      ,[Name]
  ...
  CREATE VIEW vw_XXX_Projects AS 
  SELECT [ProjectID]
      ,[ProjectNo]
      ,[OfficeID]
      ,[SeqNo]
  ...
  CREATE VIEW vw_XXX_ProjectTasks AS 
  SELECT [TaskID]
      ,[ProjectID]
      ,[GroupID]
      ,[TaskNo]
  ...
  CREATE VIEW vw_XXX_ProjectVariationItems AS 
  ...
  CREATE VIEW vw_XXX_ProjectVariations AS 
  SELECT [VariationID]
      ,[ProjectID]
      ,[VariationNo]
      ,[RevNo]
	...
	CREATE VIEW vw_XXX_ProjectTimeCodeConfigs AS 
	SELECT
	...
	CREATE VIEW vw_XXX_Custom_Report AS 
	SELECT
	...
	WHERE dbo.Projects.ProjectID = 1111
