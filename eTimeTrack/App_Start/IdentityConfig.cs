...
namespace eTimeTrack
{
    ...
    public class ApplicationUserManager : UserManager<Employee, int>
    {
        ...
        public static ApplicationUserManager Create(IdentityFactoryOptions<ApplicationUserManager> options, IOwinContext context) 
        {
            ...
            {
                manager.UserTokenProvider = new DataProtectorTokenProvider<Employee, int>(dataProtectionProvider.Create("ASP.NET Identity")) {TokenLifespan = TimeSpan.FromDays(7.0)};
            }
            return manager;
        }
    }
