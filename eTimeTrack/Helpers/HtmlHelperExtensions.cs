...
public static class HtmlHelperExtensions
{
    ...
    public static MvcHtmlString EditorForMany<TModel, TValue>(this HtmlHelper<TModel> html, Expression<Func<TModel, IEnumerable<TValue>>> propertyExpression, string templateName = null, Expression<Func<TValue, string>> indexResolverExpression = null, bool includeIndexField = true) where TModel : class
    {
        ...
        foreach (var item in items)
        {
            ...
            htmlBuilder.Append(html.EditorFor(singleItemExp, templateName, string.Format("{0}[{1}]", htmlFieldName, guid)));
        }
